...
async def 도움(ctx):
    ...
    embed.set_thumbnail(url = "https://cdn.discordapp.com/attachments/1013779830120136825/1013859385484783728/cb3606e72f718b9f.png")
    await ctx.send(embed=embed)
...
bot.run('MTAxMzg1NTc2NzEzODQyMjkwNA.GbFtF2.ysJ1PZcXY2zX6foxsUv9-6J6TrC8S9xUGrFwcg')